import svgPaths from "./svg-rhocyu3v1h";

function Frame3() {
  return <div className="absolute bg-[rgba(255,255,255,0.7)] h-[1032px] left-[144px] rounded-[42px] top-[24px] w-[1752px]" />;
}
...
export default function Component() {
  return (
    <div className="bg-[#eaedf2] overflow-clip relative rounded-[60px] size-full" data-name="框架-随行发现">
      ...
      <Frame2 />
      <Frame6 />
      <div className="absolute content-stretch flex gap-[90px] items-center left-[144px] overflow-clip p-[24px] rounded-[18px] top-[24px] w-[1752px]" data-name="二级文字导航栏-全页面">
        <Frame />
        <Frame1 />
      </div>
    </div>
