...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[30px] items-start relative shrink-0">
      <div className="bg-[rgba(255,255,255,0.92)] content-stretch flex h-[84px] items-center justify-center px-[42px] relative rounded-[42px] shadow-[0px_3px_12px_0px_rgba(0,0,0,0.12)] shrink-0" data-name="btn">
