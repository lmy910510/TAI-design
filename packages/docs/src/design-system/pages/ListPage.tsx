...
import { List, ListItem, Switch, Button } from "@tai-design/components";
  ...
  return (
    <div className="max-w-5xl pb-24">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold mb-4">List 列表</h1>
      ...
      <div className="space-y-12">
        ...
        <section>
          <div className="mb-4">
            <h2 className="text-2xl font-bold flex items-center gap-2">
              1. 基础单行列表 (Single-line List)
            </h2>
            <p className="mt-2" style={{ color: colors.text.tertiary }}>
              <strong style={{ color: BRAND.blue }}>使用场景：</strong>仅包含主标题，高度最小为 <code style={{ backgroundColor: colors.bg.code }} className="px-1 py-0.5 rounded text-sm">96px</code> (16 × 6px)。常用于基础菜单导航。
            </p>
          </div>
          ...
          <div className="p-12 border rounded-[42px]" style={{
            ...
            <CardComponent variant="white" className="w-full max-w-xl !p-0 overflow-hidden">
              <List isDark={isDark}>
                <ListItem 
                  title="车辆设置" 
                  showArrow 
                ...
                <ListItem 
                  title="系统升级" 
                  showArrow 
                  suffixContent={<span style={{ color: BRAND.red }}>有新版本</span>}
                  onClick={() => console.log("clicked")}
                />
              </List>
            </CardComponent>
        ...
        <section>
          <div className="mb-4">
            ...
            <p className="mt-2" style={{ color: colors.text.tertiary }}>
              <strong style={{ color: BRAND.blue }}>使用场景：</strong>包含主副标题与前缀图标，高度最小为 <code style={{ backgroundColor: colors.bg.code }} className="px-1 py-0.5 rounded text-sm">120px</code> (20 × 6px)。常用于展示详情内容，如个人中心、音乐列表。
            </p>
          </div>
                ...
                <ListItem 
                  ...
                  prefixIcon={
                    <div style={{
                      ...
                      <UserCircleIcon style={{ fontSize: 42 }} />
                    </div>
                  }
                  showArrow 
                  onClick={() => console.log("clicked")}
                ...
                <ListItem 
                  ...
                  prefixIcon={
                    <div style={{
                      ...
                      <LocationIcon style={{ fontSize: 42 }} />
                    </div>
                  }
                  showArrow 
                  onClick={() => console.log("clicked")}
        ...
        <section>
          <div className="mb-4">
            <h2 className="text-2xl font-bold flex items-center gap-2">
              3. 交互控制列表 (Control List)
            </h2>
            <p className="mt-2" style={{ color: colors.text.tertiary }}>
              <strong style={{ color: BRAND.blue }}>使用场景：</strong>右侧为 Switch 开关、Button 等控件，可以直接进行功能调整。
            </p>
          </div>
